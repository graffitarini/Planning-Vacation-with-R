...
Note that in our solution code, we’ll be planning a vacation to Rotterdam, the Netherlands. Feel free to choose whatever location you want!

```{r}
# Create your variable here
temps_f <- c(69,77,76,72,72,73,74)
temps_f
```
...
possible_destinations <- list(rotterdam = temps_f,moscow=c(69, 73, 54, 56, 53, 58, 59),granada=c(79, 74, 70, 68, 73, 68, 72))
